...
class SecurelogParserOutputTest < Test::Unit::TestCase
  ...
  def test_emit
    ...
    d.run do
      d.emit('message' => "Jan 17 02:47:59 hostname sshd[10654]: Received disconnect from 0.0.0.0: 11: Bye Bye")
      d.emit('message' => "Jan 17 10:00:34 hostname sudo: example: TTY=pts/00 ; PWD=/home/example ; USER=root ; COMMAND=ls")
      d.emit('message' => "Jan 17 10:31:29 hostname sshd[13352]: Accepted publickey for example from 0.0.0.0 port 55555 ssh2")
    end
